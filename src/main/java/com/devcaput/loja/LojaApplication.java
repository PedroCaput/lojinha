...
public class LojaApplication implements CommandLineRunner {
	//Instancia categorias no startup da aplicação

	@Autowired//injeta a dependencia do componente declarado, no caso, CategoryRepository
	...
	@Override//interface responsavel por inicializar as categorias
